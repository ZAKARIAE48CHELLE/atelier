    ...
    return [
      {
        ...
        classeActionCitoyenne: 'code_284',
        ...
        translations: {
          ...
          language: 'fr',
          description:"<h3>Plateformes et étanchéité de toitures plates</h3><p>Asphaltage et Etanchéité à Binche réalise tout vos travaux de toiture plate et d'étanchéité de plateforme, terrasse et balcon en Wallonie et Bruxelles.</p><p><br></p><p>Selon vos besoin et le type de&nbsp;<strong>bâtiment, nous vous conseillerons la meilleure technique parmi les membranes bitumineuses, EPDM, PVC, Rhepanol, Resitrix, ...</strong></p><p></p><p><br></p><p>Nous aménageons également vos chemin d'accès et parking en asphalte.</p><p>Nous posons du bardage ou des coupoles de toit.</p><p>Faites appel à notre expérience de plus de 40 ans pour vos travaux de plateforme et d'étanchéité.</p><p>Demandez votre devis.</p>",
